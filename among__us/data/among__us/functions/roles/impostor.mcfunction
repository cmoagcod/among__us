...
item replace entity @a[tag=impostor] hotbar.8 with minecraft:written_book{pages:['["",{"text":"SABOTAGE","bold":true},{"text":"\\n--------\\n","color":"reset"},{"text":"Sabotage O2","clickEvent":{"action":"run_command","value":"/function among__us:opt/o2"}},{"text":"\\n"},{"text":"Sabotage Lumières","clickEvent":{"action":"run_command","value":"/function among__us:opt/light"}},{"text":"\\n"},{"text":"Sabotage Communication","clickEvent":{"action":"run_command","value":"/function among__us:opt/coms"}}]'],title:SABOTAGE,author:God,display:{Name:'[{"text":"SABOTAGE","bold":true,"color":"red"}]'}}
